            ...
            <div class="navbar-vertical-content perfect-scrollbar scrollbar">
              ...
              <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <li class="nav-item"><a class="nav-link" href="changelog.html">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-code-branch"></span></span><span class="nav-link-text"> Changelog</span><span class="badge badge-pill ml-2 badge-soft-primary">v2.8.0</span></div>
                  </a></li>
              </ul>
        ...
        <nav class="navbar navbar-light navbar-glass navbar-top sticky-kit navbar-expand-lg" style="display:none;">
          ...
          <ul class="navbar-nav navbar-nav-icons ml-auto flex-row align-items-center">
            <li class="nav-item d-none d-md-block">
              <a class="nav-link px-3 py-0" href="https://prium.github.io/falcon/v3.0.0-beta1/" target="_blank"><img src="assets/img/logos/bootstrap-5.png" alt="" height="35" /></a>
            </li>
            <li class="nav-item">
