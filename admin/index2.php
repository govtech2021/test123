...
<html lang="en-US" dir="ltr" class="fontawesome-i2svg-active fontawesome-i2svg-complete chrome windows navbar-vertical-collapsed"><script id="tinyhippos-injected">if (window.top.ripple) { window.top.ripple("bootstrap").inject(window, document); }</script><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <script src="/down1/config.navbar-vertical.min.js.download"></script>
...
@keyframes chartjs-render-animation{from{opacity:.99}to{opacity:1}}.chartjs-render-monitor{animation:chartjs-render-animation 1ms}.chartjs-size-monitor,.chartjs-size-monitor-expand,.chartjs-size-monitor-shrink{position:absolute;direction:ltr;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1}.chartjs-size-monitor-expand>div{position:absolute;width:1000000px;height:1000000px;left:0;top:0}.chartjs-size-monitor-shrink>div{position:absolute;width:200%;height:200%;left:0;top:0}</style><style piggy-ext="" data-styled-version="4.4.1"></style><style piggy-ext="" data-styled-version="4.4.1"></style></head>
  ...
  <body data-new-gr-c-s-check-loaded="14.996.0" data-gr-ext-installed="">
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="/down1/jquery.min.js.download"></script>
    <script src="/down1/popper.min.js.download"></script>
    <script src="/down1/bootstrap.min.js.download"></script>
    <script src="/down1/all.min.js.download"></script>
    <script src="/down1/stickyfill.min.js.download"></script>
    <script src="/down1/sticky-kit.min.js.download"></script>
    ...
    <script src="/down1/dataTables.responsive.js.download"></script>
    <script src="/down1/responsive.bootstrap4.js.download"></script>
    <script src="/down1/leaflet.js.download"></script>
    <script src="/down1/leaflet.markercluster.js.download"></script>
    <script src="/down1/leaflet-tilelayer-colorfilter.min.js.download"></script>
    <script src="/down1/theme.min.js.download"></script>
